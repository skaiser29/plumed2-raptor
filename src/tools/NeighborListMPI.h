...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_tools_NeighborListMPI_h
#define __PLUMED_tools_NeighborListMPI_h
...
public:
  MPI_Datatype mpi_unsigned_pair;
  NeighborListMPI(const std::vector<PLMD::AtomNumber>& list0,
  ...
  NeighborListMPI(const std::vector<PLMD::AtomNumber>& list0, const bool& do_pbc,
               const PLMD::Pbc& pbc, const double& distance,
